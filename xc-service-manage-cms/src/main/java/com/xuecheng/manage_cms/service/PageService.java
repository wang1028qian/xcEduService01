...
public class PageService {
    ...
    public CmsPageResult save(CmsPage cmsPage) {
        ...
        CmsPage one = cmsPageRepository.findByPageNameAndSiteIdAndPageWebPath(pageName,
                                                                                siteId,
                                                                                pageWebPath);
        if(one!=null){
            //进行更新
    ...
    public CmsPostPageResult postPageQuick(CmsPage cmsPage) {
        ...
        //执行页面静态化(先静态化，保存GridFS，向MQ发送消息)
        ResponseResult post = this.post(pageId);
        if (!post.isSuccess()){
            ExceptionCast.cast(CommonCode.FAIL);
        }
        //拼接页面Url=cmsSize.siteDomain+cmsSite.siteWebPath+cmsPage.pageWebPath+cmsPage.pageName
        //取出战点id
